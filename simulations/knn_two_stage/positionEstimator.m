function [decodedPosX, decodedPosY, newParams, pred_classes] = positionEstimator(past_current_trial, modelParams, direc, pred_classes)
    ...
    if isempty(past_current_trial.decodedHandPos)
        ...
        % Standardize and project test data
        ...
        % dists = pdist2(Xpca_test, regressor.Xpca);

        % % Find k-nearest neighbors
        % [~, idx] = mink(dists, regressor.k, 2);  % return k smallest distances
